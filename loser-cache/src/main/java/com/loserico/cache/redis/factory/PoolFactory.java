...
/**
 * Redis连接池共产类，生成JedisPool 或者 ShardedJedisPool
 * <p>
 * Copyright: Copyright (c) 2018-05-12 16:39
 * <p>
 * Company: DataSense
 * <p>
...
public interface PoolFactory {
	...
	public default JedisPoolConfig config(PropertyReader propertyReader) {
		...
		config.setTimeBetweenEvictionRunsMillis(
				propertyReader.getInt("redis.timeBetweenEvictionRunsMillis", 60000));
		//这一项只有在timeBetweenEvictionRunsMillis大于0时才有意义
		config.setMinEvictableIdleTimeMillis(
				propertyReader.getInt("redis.minEvictableIdleTimeMillis", 30000));
