 ...
 * 读写excel
 * <p>
 * Copyright: Copyright (c) 2018-09-21 17:34
 * <p>
 * Company: DataSense
 * <p>
...
public class ExcelUtils {
	...
	public static void main(String[] args) {
		Matcher matcher = precisionNumberPlaceholderPattern.matcher("${receivable}n-");
		if (matcher.matches()) {
	...
	public static VarInfo varInfo(Row row, int cellIndex) {
		...
		List<Pattern> patterns = asList(dateTimePattern, dateTimeShortPattern1, precisionNumberPlaceholderPattern,
				placeholderPattern);
