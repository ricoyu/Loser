...
public class JPACriteriaQuery<T> implements Serializable {
	...
	public JPACriteriaQuery<T> addPredicate(com.loserico.orm.jpa.predicate.Predicate predicate) {
		this.predicates.add(predicate.toPredicate(criteriaBuilder, root));
		return this;
	}

	public JPACriteriaQuery<T> addPredicates(com.loserico.orm.jpa.predicate.Predicate... predicates) {
	...
	public JPACriteriaQuery<T> addPredicates(List<com.loserico.orm.jpa.predicate.Predicate> predicates) {
		if (predicates != null && predicates.size() > 0) {
			for (com.loserico.orm.jpa.predicate.Predicate predicate : predicates) {
	...
	/**
	 * JPA 2.1 JOIN FETCH
	 * @see leftJoinFetch(String... attributeNames)
	 * 
	 * @param attributeName
	 * @return Fetch<Z, X>
	 * @on
