...
public class ReflectionUtils {
	 ...
	 * {@code targetObject} to the supplied {@code value}. <p>This method delegates to
	 * {@link #setField(Object, String, Object, Class)}, supplying {@code null} for
	 ...
	 * the provided {@code targetObject} to the supplied {@code value}. <p>This method
	 * delegates to {@link #setField(Object, Class, String, Object, Class)}, supplying
	 ...
	 * provided {@code targetClass} to the supplied {@code value}. <p>This method
	 * delegates to {@link #setField(Object, Class, String, Object, Class)}, supplying
	 ...
	 * {@code value}. <p>This method delegates to
	 * {@link #setField(Object, Class, String, Object, Class)}, supplying {@code null}
	 ...
	 * {@code value}. <p>If the supplied {@code targetObject} is a <em>proxy</em>, it
	 * will be {@linkplain AopUtils#getUltimateTargetObject unwrapped} allowing
	 * the field to be set on the ultimate target of the proxy. <p>This method
	 * traverses the class hierarchy in search of the desired field. In addition, an
	 * attempt will be made to make non-{@code public} fields <em>accessible</em>,
	 * thus allowing one to set {@code protected}, {@code private}, and
	...
	/**
	 * Get the value of the {@linkplain Field field} with the given {@code name} from
	 * the provided {@code targetObject}. <p>This method delegates to
	 * {@link #getField(Object, Class, String)}, supplying {@code null} for the
	 * {@code targetClass} argument.
	 * 
	 ...
	 * {@code name} from the provided {@code targetClass}. <p>This method delegates to
	 * {@link #getField(Object, Class, String)}, supplying {@code null} for the
	 * {@code targetObject} argument.
	 * 
	...
	/**
	 * Get the value of the {@linkplain Field field} with the given {@code name} from
	 * the provided {@code targetObject}/{@code targetClass}. <p>If the supplied
	 * {@code targetObject} is a <em>proxy</em>, it will be
	 * {@linkplain AopUtils#getUltimateTargetObject unwrapped} allowing the field
	 * to be retrieved from the ultimate target of the proxy. <p>This method traverses
	 * the class hierarchy in search of the desired field. In addition, an attempt
	 * will be made to make non-{@code public} fields <em>accessible</em>, thus
	 * allowing one to get {@code protected}, {@code private}, and
	 * <em>package-private</em> fields.
	 * 
	 * @param targetObject the target object from which to get the field; may be
	 *            {@code null} if the field is static
	 * @param targetClass the target class from which to get the field; may be
	 *            {@code null} if the field is an instance field
	 * @param name the name of the field to get; never {@code null}
	 * @return the field's current value
	 * @since 4.2
	 ...
	 * object with the supplied {@code value}. <p>This method traverses the class
	 * hierarchy in search of the desired method. In addition, an attempt will be made
	 * to make non-{@code public} methods <em>accessible</em>, thus allowing one to
	 * invoke {@code protected}, {@code private}, and <em>package-private</em> setter
	 * methods. <p>In addition, this method supports JavaBean-style <em>property</em>
	 * names. For example, if you wish to set the {@code name} property on the target
	 * object, you may pass either &quot;name&quot; or &quot;setName&quot; as the
	 * method name.
	 * 
	 ...
	 * hierarchy in search of the desired method. In addition, an attempt will be made
	 * to make non-{@code public} methods <em>accessible</em>, thus allowing one to
	 * invoke {@code protected}, {@code private}, and <em>package-private</em> getter
	 * methods. <p>In addition, this method supports JavaBean-style <em>property</em>
	 * names. For example, if you wish to get the {@code name} property on the target
	 * object, you may pass either &quot;name&quot; or &quot;getName&quot; as the
	 * method name.
	 * 
	 ...
	 * with the supplied arguments. <p>This method traverses the class hierarchy in
	 * search of the desired method. In addition, an attempt will be made to make
	 * non-{@code public} methods <em>accessible</em>, thus allowing one to invoke
	 * {@code protected}, {@code private}, and <em>package-private</em> methods.
	 * 
