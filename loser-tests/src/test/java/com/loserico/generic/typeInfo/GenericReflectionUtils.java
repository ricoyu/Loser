 ...
 */
public final class GenericReflectionUtils {

	/**
	 * When {@code Type} initialized with a value of an object, its fully qualified
	 * class name will be prefixed with this.
	 * 
	 ...
	 */
	private GenericReflectionUtils() {
	}
	 ...
	 * @return
	 */
	public static Type[] getMethodReturnTypeArgs(Class<?> clazz, String methodName) {
