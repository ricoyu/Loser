...
public class NestedObjectMapTest {
	...
	public void usingAnnotationsTest() throws IOException {
	    Product product = new ObjectMapper()
	      ...
	      .readValue(IOUtils.readClassPathFile("nested-object.json"));
	...
	public void usingJsonNodeTest() throws IOException {
	    JsonNode productNode = new ObjectMapper().readTree(IOUtils.readClassPathFile("nested-object.json"));
	...
	public void usingDeserializerManuallyRegisteredTest()
	 throws IOException {
	    ...
	    Product product = mapper.readValue(IOUtils.readClassPathFile("nested-object.json"), Product.class);
