...
public class UsePartsDB {
	...
	/**
	 * main() method begins by instantiating PartsDB, with parts.db as the name of the database
	 * file. When this file has no records, numRecs() returns 0 and several records are appended
