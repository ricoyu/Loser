package com.loserico.search.lucene.official;
...
public class IndexFiles {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 * max heap size to the JVM (eg add -Xmxm or -Xmx1g):
			 ...
			 * generally it's only worth it when your index is relatively static (ie
   ...
   */
	...
	static void indexDoc(IndexWriter writer, Path file, long lastModified) throws IOException {
		try (InputStream stream = Files.newInputStream(file)) {
			 ...
			 * indexed (i.e. searchable), but don't tokenize the field into separate
			 * words and don't index term frequency or positional information:
			 */
			 ...
			 * LongField that is indexed (i.e. efficiently filterable with
			 * NumericRangeFilter). This indexes to milli-second resolution, which is
			 * often too fine. You could instead create a number based on
			 * year/month/day/hour/minutes/seconds, down the resolution you require.
			 * For example the long value 4 would mean February 17, 1, 2-3 PM.
			 */
